...
const ChooseCorrectWordGamePage = () => {
  ...
  const { generateWordQuestions } = useGameQuestions();
  const { addLearnedWord } = useLearnedWords();

  // Khởi tạo game
  const initializeGame = useCallback(() => {
    const gameQuestions = generateWordQuestions();
...
export default ChooseCorrectWordGamePage;
